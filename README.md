...
### About me
ISTQB Certified QA Engineer with 4 years of experience working with web and mobile applications using back-end (API, DB) and front-end (GUI, functional) testing methods.
